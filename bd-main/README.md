# Butsky Group — Автоматизация бухгалтерского учёта

Авторская программа бухгалтерского учёта с ИИ-распознаванием документов, автоматическим расчётом налогов и формированием отчётов.
