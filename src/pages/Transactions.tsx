...
export default function Transactions() {
  ...
  const openEdit = (tx: Transaction) => {
    ...
    setForm({
      ...
      is_cashless: tx.is_cashless === true,
    });
    setError("");
    setShowForm(true);
    window.scrollTo(0, 0);
  ...
  return (
    <div className="animate-fade-in space-y-3">
      ...
      {/* Modal */}
      {showForm && (
        <div className="fixed inset-0 bg-black/60 z-50 flex items-start justify-center pt-4 sm:pt-10 p-4 overflow-y-auto" onClick={() => setShowForm(false)}>
          <div className="w-full max-w-lg card-fin rounded-xl p-4 sm:p-5 space-y-4" onClick={(e) => e.stopPropagation()}>
            ...
            {/* is_cashless toggle */}
            <button type="button" onClick={() => setForm((f) => ({ ...f, is_cashless: !f.is_cashless }))}
